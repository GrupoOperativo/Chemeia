                ...
                <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                    <div class="flex-fill">
                        <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="iniciado.html">Home</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <%out.println("<a class='nav-link' href='#'> " + sesion.getAttribute("usuario") + " </a>");%>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            ...
                            | Diseñado por <a rel="sponsored" href="logIn.jsp" target="_blank">Grupo Operativo</a>
                        </p>
                    </div>
                </div>
            </div>  
